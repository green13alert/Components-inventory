...
export function WorkbenchSurface({ width, height }: WorkbenchSurfaceProps) {
  ...
  return (
    <Svg width={width} height={height} viewBox={`0 0 ${vbW} ${vbH}`} preserveAspectRatio="none">
      ...
      <Path d={topFace} fill="url(#benchTop)" stroke={colors.border} strokeWidth={0.8} />
      ...
      <WorkbenchProps colors={colors} />
    </Svg>
  );
}

function WorkbenchProps({ colors }: { colors: SolderiPalette }) {
  return (
    <G opacity={0.55}>
      <G transform="translate(28, 118)">
        <Rect x={0} y={8} width={28} height={5} rx={1.5} fill="#3A4044" />
        <Rect x={24} y={0} width={6} height={14} rx={1} fill={colors.accent} opacity={0.65} />
      </G>

      <G transform="translate(318, 122)">
        <Path d="M 0 12 L 8 0 L 10 2 L 4 14 Z" fill={colors.textMuted} />
        <Path d="M 12 12 L 20 0 L 22 2 L 16 14 Z" fill={colors.textMuted} opacity={0.7} />
      </G>

      <G transform="translate(330, 68)">
        <Circle cx={12} cy={12} r={11} fill="none" stroke={colors.border} strokeWidth={1.2} />
        <Circle cx={12} cy={12} r={5} fill={colors.surfaceElevated} />
        <Line x1={12} y1={1} x2={12} y2={6} stroke={colors.border} strokeWidth={1} />
      </G>

      <G transform="translate(168, 62)">
        <Rect x={0} y={0} width={54} height={22} rx={3} fill={colors.surfaceElevated} stroke={colors.border} strokeWidth={0.7} />
        <Line x1={6} y1={8} x2={48} y2={8} stroke={colors.border} strokeWidth={0.6} opacity={0.5} />
        <Line x1={6} y1={14} x2={48} y2={14} stroke={colors.border} strokeWidth={0.6} opacity={0.5} />
      </G>

      <G transform="translate(52, 78)">
        <Rect x={0} y={0} width={36} height={20} rx={2} fill="#25292C" stroke={colors.border} strokeWidth={0.6} />
        {[6, 12, 18, 24, 30].map((x) => (
          <Line key={x} x1={x} y1={3} x2={x} y2={17} stroke={colors.border} strokeWidth={0.4} opacity={0.45} />
        ))}
      </G>

      <Circle cx={290} cy={130} r={3} fill={colors.accent} opacity={0.45} />
      <Rect x={72} y={132} width={10} height={3} rx={1} fill={colors.textMuted} opacity={0.5} />
      <Circle cx={248} cy={118} r={2} fill={colors.success} opacity={0.4} />
      <Circle cx={110} cy={108} r={1.5} fill={colors.textMuted} opacity={0.35} />
      <Circle cx={110} cy={112} r={1.5} fill={colors.textMuted} opacity={0.35} />
    </G>
  );
}
